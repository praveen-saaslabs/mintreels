    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            'glass-elevated z-50 inline-flex w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5',
            'rounded-xl border border-[color-mix(in_oklch,var(--glass-border)_85%,transparent)]',
            'px-3 py-2 text-xs text-foreground shadow-(--glass-shadow-elevated)',
            ...
            '**:data-[slot=kbd]:relative **:data-[slot=kbd]:isolate **:data-[slot=kbd]:z-50 **:data-[slot=kbd]:rounded',
        ...
        >
          ...
          <TooltipPrimitive.Arrow
            className={cn(
              ...
              'bg-[color-mix(in_oklch,var(--glass-bg-elevated)_92%,transparent)]',
              'fill-[color-mix(in_oklch,var(--glass-bg-elevated)_92%,transparent)]',
              'border border-[color-mix(in_oklch,var(--glass-border)_70%,transparent)] border-t-transparent border-l-transparent',
