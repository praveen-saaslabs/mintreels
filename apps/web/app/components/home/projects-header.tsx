  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-5">
      ...
      <div className="flex items-center gap-2">
        <label className="glass flex h-[34px] w-[260px] items-center gap-2 rounded-md px-2.5">
        ...
        <Link
          to="/editor/new"
          className="inline-flex h-[34px] items-center rounded-md bg-[var(--mr-acc)] px-3.5 text-[13px] font-semibold text-[var(--mr-accfg)]"
        >
          New project
        </Link>
      </div>
